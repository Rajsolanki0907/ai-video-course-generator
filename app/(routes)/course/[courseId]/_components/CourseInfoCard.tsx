...
//   if (!durationBySlideId || !slides?.length) return 30; // ✅ fallback

//   return slides.reduce(
//     (sum, slide) =>
//       sum + (durationBySlideId[slide.slideId] ?? fps * 6),
//     0
//   );
...
const slides = course?.chapterContentSlides ?? [];
  ...
  const durationInFrames = useMemo(() => {
    if (!durationBySlideId || !slides?.length) return 30;
