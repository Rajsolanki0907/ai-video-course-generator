...
const SlideFrameWithReveal = ({
  ...
  const revealPlan = useMemo(() => {
    const ids = Array.isArray(slide.revealData)
      ? slide.revealData
      : [];

    const chunks = Array.isArray(slide.captions)
      ? slide.captions
      : [];
  ...
  }, [slide.revealData, slide.captions]);
